...
class ConvNet:
    ...
    def network_fcN(self, input_shape,nb_classes,weight,flag=False):
    ...
    def trainNet(self,model,train_input,train_output,vali_input,vali_output,mini_batch_size=16,nb_epochs=10):
        #block for FCN
        batch_size = 16
        #500 for uWave
        nb_epochs = 60
        ...
        es = EarlyStopping(monitor='val_loss', mode='min', verbose=0,patience=7)
        hist = model.fit(train_input, train_output, batch_size=mini_batch_size, epochs=nb_epochs,verbose=False,  callbacks=None)
